...
- Accord : envoi via l'API Supabase vers questionnaire_responses.
...
V9.1
- Validation croisée de l’indice de plaque : surfaces avec plaque <= surfaces examinées.
- L’indice calculé ne peut plus dépasser 100 %.
- Délai maximal de 10 secondes pour l’envoi Supabase afin d’éviter un statut « enregistrement… » bloqué indéfiniment.
